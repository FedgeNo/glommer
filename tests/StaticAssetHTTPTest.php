...
class StaticAssetHTTPTest extends TestCase
{
    public function testPublicFilesAreServedWithTheirExpectedBytesAndTypes(): void
    {
        $assets = [
            ...
            '/games/roulette.js' => ['games/roulette.js', ['application/javascript', 'text/javascript']],
            '/games/poker.js' => ['games/poker.js', ['application/javascript', 'text/javascript']],
            '/games/poker.css' => ['games/poker.css', ['text/css']],
            '/games/vlt.js' => ['games/vlt.js', ['application/javascript', 'text/javascript']],
            '/games/vlt.css' => ['games/vlt.css', ['text/css']],
            '/games/singularity.js' => ['games/singularity.js', ['application/javascript', 'text/javascript']],
            '/games/singularity.css' => ['games/singularity.css', ['text/css']],
            '/games/pachinko.js' => ['games/pachinko.js', ['application/javascript', 'text/javascript']],
            '/games/pachinko.css' => ['games/pachinko.css', ['text/css']],
            '/games/cards/roulette.svg' => ['games/cards/roulette.svg', ['image/svg+xml']],
            '/games/cards/poker.svg' => ['games/cards/poker.svg', ['image/svg+xml']],
            '/games/cards/vlt.svg' => ['games/cards/vlt.svg', ['image/svg+xml']],
            '/games/cards/singularity.svg' => ['games/cards/singularity.svg', ['image/svg+xml']],
            '/games/cards/pachinko.svg' => ['games/cards/pachinko.svg', ['image/svg+xml']],
            '/games/cards/derby.svg' => ['games/cards/derby.svg', ['image/svg+xml']],
            '/games/casino.js' => ['games/casino.js', ['application/javascript', 'text/javascript']],
            '/games/roulette.css' => ['games/roulette.css', ['text/css']],
            '/games/casino.css' => ['games/casino.css', ['text/css']],
