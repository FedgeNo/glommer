...
/**
 * The /bookmarks page's list of the viewer's bookmarked posts, fetched at render
 * time. Cursors on (createdAt, postId) - when each post was bookmarked - rather
 * than a bare postId, since "most recently bookmarked first" and "most recently
 * posted first" are genuinely different orderings here; the cursor defaults to a
 * far-future sentinel so page one and a load-more page are one query. Build with
 * new BookmarkList(['userId' => 5]).
 */
