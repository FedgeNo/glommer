...
### 1. Admin page for blocked domains
The model and enforcement exist; there is no interface. A moderator can only
defederate by hand in SQL until this lands, and dropping a blocked server's
existing followers/follows is not done either.
...
### 8. Video and Audio as first-class objects
