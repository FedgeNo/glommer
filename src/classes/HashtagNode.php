...
/**
 * One tag in the /tags/ force-directed graph (HashtagGraphList): a clickable "#tag"
 ...
 * PopularHashtags table (see HashtagGraphList) -> DB::rows(); hashtagId is carried
 * only so HashtagGraphList can index the co-occurrence edges against node position.
 */
