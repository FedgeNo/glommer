...
// <ClassName>" automatically via deriveClassName(). A button with no identity
// of its own, a mismatched identity, or one that deliberately skips the shared
// styling extends Button directly instead.
