...
$payload = APIRequest::read(['q' => 'text', 'offset' => 'integer']);
...
if (SearchRateLimiter::tooManyAttempts('users', (int) Auth::id())) {
    JSONResponse::localizedError('tooManySearchesPleaseSlowDown', 429) -> send();
}
