...
', \stdClass::class);
    ...
    public function testTheHeadingNamesWhereNearbyIs(): void
    {
        ...
        // heading over it. The place's page seeds the heading, the way
        // nearby.php does after canonicalizing coordinates to a place.
        self::locatedPost(44.23, -76.48);

        (new \ReflectionProperty(HTMLObject::class, 'document')) -> setValue(null, new \DOMDocument());

        $section = new NearbyFeedSection([
            'latitude' => 44.23,
            'longitude' => -76.48,
            'heading' => 'Posts near Kingston, Ontario, Canada',
        ]);
        ...
        $this -> assertSame('Posts near Kingston, Ontario, Canada', $heading -> textContent);
    }
