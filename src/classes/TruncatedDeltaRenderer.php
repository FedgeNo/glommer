...
class TruncatedDeltaRenderer extends DeltaRenderer
{
    ...
    public function __construct(array $ops = [], private readonly ?string $seeMoreURL = null, int $max_length = self::DEFAULT_MAX_LENGTH, array $custom_emoji = [], bool $mentions_are_local = true)
    {
        [$this -> truncatedOps, $this -> truncated] = self::truncate($ops, $max_length);

        parent::__construct($this -> truncatedOps, $custom_emoji, $mentions_are_local);
    }
