...
class SetupNextSteps extends OrderedList
{
    ...
    public function toDOM(): \DOMElement
    {
        $steps = [
            ...
            'Open /signup in this same authorized browser to create the administrator. Other browsers cannot register until this is complete. If the session is lost, run php bin/install.php --setup-code on the server to issue a replacement code.',
        ];
