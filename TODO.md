...
- **Moderation stops working on message content.** A report about a message
  cannot be reviewed if nobody but the participants can read it. That is a
  deliberate trade, not an oversight, and it needs deciding up front.
